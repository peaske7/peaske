...
<div class="max-w-[600px] w-full mx-auto px-4 py-8 h-screen flex flex-col">
	<header class="mb-12">
		<nav class="space-x-4">
			<a href="/">peaske</a>
	...
	<footer class="mt-30 pt-8 pb-4 border-t border-gray-200">
		<p class="text-sm opacity-60">Great reads</p>
